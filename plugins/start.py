...
async def start(client, message):
	...
	I am file renamer bot, Please send any telegram**Document Or Video** and enter new filename to rename it"""
    ...
    if id:
        if old == True:
            ...
            await client.send_message(id, "Congrats! You Won 200MB Upload limit")
	...
	""", reply_to_message_id=message.id,
                                     reply_markup=InlineKeyboardMarkup(
                                         [[InlineKeyboardButton("🔺 UPDATE CHANNEL 🔺", url="https://t.me/llathu63035")],
                                          [InlineKeyboardButton("MOVIES BOT", url="https://t.me/suchitha1bot")],
                                          [InlineKeyboardButton("SUPPORT GROUP ", url='https://t.me/ntmgroup'),
                                          InlineKeyboardButton("DEVELOPER", url='https://t.me/suchitha1bot')],
                                          [InlineKeyboardButton("☕ BUY ME A COFFEE ☕", url='https://p.paytm.me/xCTH/vo37hii9')]
                                          ]))
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton(" CONTACT DEVELOPER ", url='https://telegram.me/sula20062007')],
                                                                     [InlineKeyboardButton("🔺 MOVIES BOT 🔺", url='https://t.me/suchitha1bot')],
                                                                     [InlineKeyboardButton(" VISIT CHANNEL  ", url='https://t.me/llathu63035'),
                                                                     InlineKeyboardButton("  SUPPORT GROUP ", url='https://t.me/ntmgroup')],
                                                                     [InlineKeyboardButton("☕ BUY ME A COFFEE ☕", url='https://p.paytm.me/xCTH/vo37hii9')]
                                                                    ]))
        await message.reply_text(text=f"🦋")
